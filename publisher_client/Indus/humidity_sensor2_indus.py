'''For the humidity of city of Qambar'''
# client_put.py
import asyncio
import random
import requests
...
async def main():
    ...
    for i in range(24):
        ...
        if c=="increment":
            ...
            temp = temp - rn
        data = "{}".format(temp)
        request = Message(code=POST, payload=data.encode("ascii"), uri='coap://localhost:5683/Indus_humidity_sensor2')
        try:
